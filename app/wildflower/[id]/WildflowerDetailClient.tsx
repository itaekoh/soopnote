...
export default function WildflowerDetailClient({ postId }: { postId: number }) {
  ...
  async function loadCurrentUser() {
    ...
    console.log('🔍 [loadCurrentUser] user:', user?.id, user?.email);
    if (user) {
      ...
      // 로그아웃 상태
      console.log('🔍 [loadCurrentUser] 로그아웃 상태 - 상태 초기화');
