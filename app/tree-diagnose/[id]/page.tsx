...
export default function TreeDiagnoseDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#F5F3EE_0%,#F8FAF8_60%)] text-gray-800">
      ...
      <article className="max-w-4xl mx-auto px-6 py-12">
        ...
        {/* 카테고리 배지 */}
        <div className="mb-4">
          <span className="inline-block px-4 py-2 rounded-full bg-amber-50 text-amber-700 text-sm font-medium">
            {post.category_name}
          </span>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 text-center">
          <Link
            href="/tree-diagnose"
            className="inline-flex items-center gap-2 px-8 py-3 bg-amber-700 text-white rounded-lg hover:bg-amber-800 transition-colors font-medium"
          >
