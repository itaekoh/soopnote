...
BEGIN
  ...
  -- 새로운 서브카테고리 생성
  INSERT INTO sn_categories (name, slug, type, parent_id, attribute_key, display_order, created_at, updated_at) 
  VALUES
    ('Daily', 'daily', 'attribute', logs_category_id, 'subcategory', 1, NOW(), NOW()),
    ('Tech', 'tech', 'attribute', logs_category_id, 'subcategory', 2, NOW(), NOW()),
    ('Insights', 'insights', 'attribute', logs_category_id, 'subcategory', 3, NOW(), NOW()),
    ('Tree & Field', 'tree-field', 'attribute', logs_category_id, 'subcategory', 4, NOW(), NOW()),
    ('Business', 'business', 'attribute', logs_category_id, 'subcategory', 5, NOW(), NOW());
